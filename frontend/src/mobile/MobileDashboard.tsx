...
export default function MobileDashboard() {
  ...
  return (
    <div className="flex flex-col gap-5 px-4 pt-6">
      ...
      <div className="flex items-center divide-x divide-white/10 rounded-2xl bg-white/5 px-1 py-3">
        <MobileStat
          label="Net worth"
...
function MobileStat({
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col items-center gap-0.5 px-1 first:pl-0 last:pr-0">
      <span className={`flex items-center gap-1 text-[10px] uppercase tracking-wide text-gray-500 ${color}`}>
        {icon} {label}
      </span>
